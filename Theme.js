function themeMars(){
    ...
    document.documentElement.style.setProperty("--thumbColor1","rgb(25, 5, 5)")
    ...
    document.documentElement.style.setProperty("--thumbColor2","#ef9898")
    document.documentElement.style.setProperty("--trackColor2","#823520")
...
function themeMariGold(){
    ...
    document.getElementsByClassName("profoot")[0].style.backgroundColor = "rgb(118, 93, 21)"
    document.documentElement.style.setProperty("--thumbColor1","rgb(30, 148, 60)")
